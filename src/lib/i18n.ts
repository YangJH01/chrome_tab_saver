...
const translations: Record<LanguageCode, TranslationDictionary> = {
  ko: {
    ...
    saveSuccessAndClosed: (count) => `${count}개 탭을 저장하고 현재 창에서 닫았습니다.`,
    ...
    saveTabsBehaviorDescription: "세션 저장 직후 현재 창의 탭을 그대로 둘지, 모두 닫을지 정합니다.",
    saveTabsKeep: "탭 유지",
    saveTabsKeepDescription: "저장 후에도 현재 탭들을 그대로 둡니다.",
    saveTabsClose: "탭 닫기",
    saveTabsCloseDescription: "저장 직후 현재 창의 탭들을 모두 닫습니다.",
  ...
  en: {
    ...
    saveSuccessAndClosed: (count) => `Saved ${count} tab${count === 1 ? "" : "s"} and closed them from the current window.`,
    ...
    saveTabsBehaviorDescription: "Choose whether the current window tabs stay open or are closed right after saving.",
    saveTabsKeep: "Keep tabs",
    saveTabsKeepDescription: "Leave the current window tabs open after saving.",
    saveTabsClose: "Close tabs",
    saveTabsCloseDescription: "Close all tabs in the current window right after saving.",
